    ...
    <div class="container" align="center" style="max-width: 800px;">
        ...
        <div class="my-auto">
            ...
            <form id="review-form" action="includes/review-helper.php" method="post">
                ...
                <input type="text" name="review-title" id="review-title" style="width: 100%; margin-bottom: 100px;">
                <textarea name="review" id="review-text" cols="60" rows="3" placeholder="Enter a comment... "></textarea>
